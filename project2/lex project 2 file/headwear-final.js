...
$(window).scroll(function() {
  ...
  if (scroll >= winHeight3-300 && scroll <= winHeight3+300) {
    ...
    $(".img-hijab-bg").addClass("fadeInUp-hijab");
  ...
  if (scroll >= winHeight5-300 && scroll <= winHeight5+300) {
    ...
    $(".img-jew-bg-bird").addClass("fadeInRight-bird");
  ...
  if (scroll >= winHeight9-300 && scroll <= winHeight9+200) {
    $(".scene").removeClass("active");
    ...
    $(".img-tattoo-bg-L").addClass("fadeInDown-tattoo");
    $(".img-tattoo-bg-R").addClass("fadeInUp-tattoo");
  ...
  if (scroll >= winHeight10-300 && scroll <= winHeight10+300) {
    $(".scene").removeClass("active");
    $(".scene11").addClass("active");

    $(".nonmoving-face").toggleClass("hideme");
    $(".img-tattoo-eyes").toggleClass("hideme");

    $(".scene11 .txt-lastread").addClass("fadeIn-firstread");
    ...
    $("body").removeClass("scene-change-9");
    $("body").removeClass("scene-change-10");
    $("body").addClass("scene-change-11");

    $('html, body').animate({
        scrollTop: $(".scene11").offset().top
    }, 200);
    $(window).bind("mousewheel", function() {
        $("html, body").stop();
    });
